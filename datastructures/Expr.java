...
public class Expr {
	...
	private byte[] code; // A translated version of the expression, containing
							// stack operations that compute the value of the
							// expression.
	...
	private static String[] functionNames = { // names of standard functions,
												// used during parsing
			"sin", "cos", "tan", "cot", "sec", "csc", "arcsin", "arccos", "arctan", "exp", "ln", "log10", "log2", "abs",
			"sqrt" };

	private double eval(double variable) { // evaluate this expression for this
	...
	private void parse(String definition) { // Parse the definition and produce
											// all
											// the data that represents the
											// expression
											// internally; can throw
